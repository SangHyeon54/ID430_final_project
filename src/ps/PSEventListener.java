...
public class PSEventListener implements MouseListener, MouseMotionListener, 
    KeyListener{
    //fields
    private PSApp mApp = null;
    
    //constructor
    public PSEventListener(PSApp app) {
        this.mApp = app;
    }
    ...
    public void mousePressed(MouseEvent e) {
        if (this.mApp.getPenMarkMgr().mousePressed(e)) {       
            PSScene curScene = (PSScene) this.mApp.getScenarioMgr().
                getCurScene();
    ...
    public void mouseDragged(MouseEvent e) {
        if (this.mApp.getPenMarkMgr().mouseDragged(e)) {
            PSScene curScene = (PSScene) this.mApp.
